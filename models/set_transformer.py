...
############
"""
Code largely from https://github.com/ml-research/NeSyConceptLearner/blob/main/src/model.py by Wolfgang Stammer.
...
class SetTransformer(nn.Module):
    ...
    Attention-based Permutation-Invariant Neural Network
    """

    def __init__(self, dim_input=1, dim_output=2, dim_hidden=128, num_heads=4, ln=False):
        """
